...
<@n.navbar selected="admin">
    <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="/admin/markCar">Марки</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1" style="text-align: center">
                <br/>
                <a href="/admin/markCar/add"><button type="button" class="btn btn-default">Добавить марку</button></a>
                <br/>
                <br/>
            </div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <#list markCars as markCar>
                            <tr>
                                <td>${markCar_index + 1}</td>
                                <td>${markCar.name}</td>
                                <td style="text-align: right">
                                    <a href="/admin/markCar/edit?bcmId=${markCar.bcmId}"><i class="fas fa-edit"></i></a>
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="/admin/markCar/delete?bcmId=${markCar.bcmId}"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        </#list>
                    </tbody>
